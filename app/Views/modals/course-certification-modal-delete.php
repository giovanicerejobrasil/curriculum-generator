...
<dialog id="course-certification-modal" class="w-[50%] m-auto p-5 rounded-md">
    <form action="course-certification-delete" method="post" class="p-3 border-2 border-(--french-rose) rounded-md">
        ...
        <div class="px-3">
            ...
            <span class="block my-2 bg-gray-200 p-2 rounded-md">
                <?= PrintF::withSize("<b>{$course_certification->course_certification}</b> - {$course_certification->institute} | {$course_certification->conclusion_year}", 100); ?>
            </span>
        </div>
