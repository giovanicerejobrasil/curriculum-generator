...
<dialog id="experience-modal" class="w-[50%] m-auto p-5 rounded-md">
    <form action="experience-delete" method="post" class="p-3 border-2 border-(--french-rose) rounded-md">
        ...
        <div class="mt-5 px-3">
            ...
            <span class="block my-2 bg-gray-200 p-2 rounded-md">
                <?php
                    $item = "<b>{$experience->job_position}</b> - {$experience->company_name} | " .
                    PrintF::dateFormat($experience->date_start, 'm/Y') . " - " . 
                    ($experience->in_progress == 'y' 
                        ? 'In Progress' 
                        : PrintF::dateFormat($experience->date_end, 'm/Y')) .
